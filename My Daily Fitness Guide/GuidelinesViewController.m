...
- (void)viewDidLoad
{
    ...
    if ([self.screenType isEqualToString:@"nutritionist"]) {
        ...
        // for trainer part
        [htmlString appendFormat:@"<html><head><style>ul {padding-left: 20px; margin-left: 10px;} h4 { text-align: center;} div {background: -webkit-linear-gradient(top, #e8e8e8, #ffffff);} li {margin-top:13px;}</style></head><body>"];
